...
const useTableUrl = (n: number = 1): { type: 'redirect', table: null, id: null } | { type: 'table', table: SchoolCityIDBTable, id: IndexableType | null } => {
	...
	if (
		...
		return {
			type: 'redirect', table: null, id: null 
		};
